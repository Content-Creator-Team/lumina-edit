...
export function ParallaxStage({ className }: { className?: string }) {
  ...
  const layers = [
    { z: 0, size: "78%", x: "18%", y: "-8%", tint: "var(--tint-2)", blur: "90px", opacity: 0.5 },
    { z: 90, size: "46%", x: "34%", y: "14%", tint: "var(--tint-1)", blur: "80px", opacity: 0.4 },
    { z: 180, size: "34%", x: "8%", y: "22%", tint: "var(--tint-3)", blur: "70px", opacity: 0.3 },
  ];
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            boxShadow: "0 0 140px 24px color-mix(in oklab, var(--tint-1) 10%, transparent) inset",
          }}
        />
        ...
        {[
          ...
          <div
            ...
            style={{
              borderColor: "var(--border)",
              background:
                "linear-gradient(140deg, color-mix(in oklab, var(--foreground) 8%, transparent), color-mix(in oklab, var(--surface-raised) 88%, transparent) 60%)",
              ...
              boxShadow: "0 40px 120px -44px color-mix(in oklab, var(--foreground) 32%, transparent)",
            }}
          >
